/*appcan.contorl for seajs   2016-8-15**/
    ...
    return function(e) { 
    	(function(appcan) {
            appcan.extend(function(a, b, c) {
                ...
                function h() {
                    return "ontouchstart" in window ? void 0 : !0
                }
                function i(a, b, c) {
                    d(a).on(h() ? "mousedown": "touchstart",
                    function() {
                        appcan.touch(b, c)
                    })
                }
                function j(a) {
                    ...
                    a.attr("data-checked", b),
                    "false" == b ? a.addClass("switch-active") : a.removeClass("switch-active"),
                    "false" == b ? a.removeClass("bc-head") : a.addClass("bc-head")
                }
                function k(a, b, c) {
                    ...
                    function(a) {
                        ...
                        f = "false" == f ? "true": "false",
                        e.attr("data-checked", f),
                        "false" == f ? e.removeClass(b ? b: "bc-head") : e.addClass(b ? b: "bc-head"),
                        f = "false" == f ? !1 : !0,
                        c(e, f)
                    })
                }
                function l(a, b) {
                    d("select", d(a)).on("change",
                    function(a) {
                        var c = d(a.currentTarget);
                        appcan.selectChange(a.currentTarget),
                        b && b(c, c.val())
                    })
                }
                function m(a, b) {
                    ...
                    function() {
                        ...
                        var a = new Function(h.clickFun);
                        a()
                    })), g.addClass(h.startClassName), g.on("webkitTransitionEnd",
                    function() {}))
                }
                function n(a, b) {
                    var c;
                    ...
                    var e = d(c);
                    "INPUT" === e.prop("tagName") && ("checkbox" === e.attr("type") && (c.checked = !c.checked), "radio" !== e.attr("type") || c.checked || (c.checked = "checked")),
                    appcan.isFunction(b) && b(a, c.checked)
                }
                function o() {
                ...
                s = function(a) {
                    a.cancelClick || (a.cancelClick = !0, a.addEventListener("click",
                    function() {
                ...
                function B() {
                    e.setBounceType("0", "rgba(255,255,255,0)", 0),
                    e.setBounceType("1", "rgba(255,255,255,0)", 0)
                }
                function C(a) {
                    var b = 0;
                    if (!a) return b;
                    if (appcan.isArray(a)) return a.length;
                    if (!appcan.isPlainObject(a)) return b;
                    for (var c in a) b++;
                    return b
                }
                function D(a, b, c, d, e) {
                    var f = b.match(/(first:|last:)(\"|\'*)([^\"\']*)(\"|\'*)/);
                    if (f) return f[1] == c ? '"' == f[2] || "'" == f[2] ? f[3] : a[f[3]] : f[1] == d && e > 1 ? "": void 0
                }
                function E(a, b, c, d, e) {
                    return a.replace(/\$\{([^\}]*)\}/g,
                    function(a, f) {
                        if (f.match(/index:/)) return c;
                        if (f.match(/cb:/) && e) return e(b, f.match(/cb:(.*)/));
                        if (0 == c) {
                ...
                function H(a, b) {
                    appcan.isFunction(a) && (b = a, a = []),
                    b = appcan.isFunction(b) ? b: function() {};
                    var c = 0,
                    d = null,
                    e = 0;
                    function f() {
                        if (e >= a.length) return void b(0);
                        var c = a[e];
                        if (c && appcan.isFunction(c)) try {
                            if (c(function(a, c) {
                                return 0 !== a ? void b(a, c) : (e++, void f())
                            }) === !1) return void b(0)
                        } catch(d) {
                            b(d)
                        }
